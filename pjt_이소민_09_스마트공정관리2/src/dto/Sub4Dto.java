...
public class Sub4Dto {
	private String w_workno, p_p1, p_p2, p_p3, w_lastdate, w_lasttime;

	public Sub4Dto(String w_workno, String p_p1, String p_p2, String p_p3, String w_lastdate, String w_lasttime) {
		super();
