...
public class PdsDto {
	...
	//수정
	public PdsDto(String no, String title, String content, String attach, String update_date) {
		super();
		this.no = no;
		this.title = title;
	...
	//조회
	public PdsDto(String no, String title, String content, String attach, String reg_name, String reg_date,
