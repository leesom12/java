...
<%}
	...
	String answer_reg_date= request.getParameter("t_a_date");
	String answer_update_date= CommonUtil.getTodayTime();
	String answer_id= sessionId;
	
	QnaDto dto= new QnaDto(no, answer_id, answer_content, answer_reg_date, answer_update_date, attach);
	int result= dao.replyUpdate(dto);
	String msg= "답변 수정이 완료되었습니다";
	if(result != 1)msg="답변 수정에 실패했습니다";
%>
<!DOCTYPE html>
<html>
<head>
