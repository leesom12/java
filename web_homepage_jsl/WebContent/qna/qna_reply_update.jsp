...
<script type="text/javascript">
	function goUpdate(){
		qna.method="post";
		qna.action="db_reply_update.jsp";
		qna.submit();
	}
</script>
	<div class="sub_title">
	...
	<div class="container">
	  ...
	  <input type="hidden" name="t_a_date" value="<%=dto.getAnswer_reg_date()%>">
	  <!-- action을 처리하기전에 check()사용자 함수를 실행하고 되돌아 와라-->
			<table class="bord_table">
				...
				<tbody>
					...
					<tr>
						<th>답변</th>
						<td colspan="3"><textarea name="t_answer"><%=dto.getAnswer_content() %></textarea></td>
					</tr>
					...
					<tr>
						...
						<th>답변 등록일</th>
						<td><%=dto.getAnswer_reg_date().substring(0, 19)%></td>
					</tr>
					<tr>
						<th>답변 수정일</th>
			...
			<div class="btn_wrap">
				<input type="submit" onclick="goUpdate()" value="수정" class="btn_ok">&nbsp;&nbsp;
