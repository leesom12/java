...
<style type="text/css">
	...
	<div class="container">
	  ...
	  <input name="t_no" value="<%=no%>" type="hidden">
	  <!-- action을 처리하기전에 check()사용자 함수를 실행하고 되돌아 와라-->
					...
					<tr>
						...
						<td colspan="3">
							<%if(dto.getAttach() != null) {%>
								...
								<input type="hidden" name="t_ori_AttachName" value="<%=dto.getAttach()%>">
							<%} %>
			...
			<div class="btn_wrap">
				<input type="submit" value="저장" class="btn_ok" onClick="goUpdate()">&nbsp;&nbsp;
