...
<html lang="ko">
 <head>
  ...
  <title>JSL인재개발원_이소민</title>
  <link href="/web_homepage_jsl/css/font-awesome.min.css" rel="stylesheet">
  <link href="/web_homepage_jsl/css/common.css" rel="stylesheet">
  <link href="/web_homepage_jsl/css/layout.css" rel='stylesheet'>
  <!--
  	jquery언어 사용법
  ...
  <script src="/web_homepage_jsl/js/jquery-3.3.1.min.js"></script>
  <script src="/web_homepage_jsl/js/common.js"></script>
  <style type="text/css">
  	 .find_css{
	...
	<div class="top_navigation">
		...
		<header class="header">
			...
			<nav class="top_right">
				<ul>
					<%
					String commonSessionName= (String)session.getAttribute("sessionName");	
					...
					<%} else{%>
						...
						<li>	
							<a href="/web_homepage_jsl/member/member_myinfo.jsp">MyPage</a>
						</li>
					<%} %>
					</li>
					<%if(commonSessionName == null) {%>
			...
			<div class="gnb_group">
				<h1 class="logo"><img src="/web_homepage_jsl/images/jsl_logo_f.png"></h1>
				<nav class="gnb">
					<ul class="nav_1depth">
						...
						<li><a href="/web_homepage_jsl/notice/notice_list.jsp">커뮤니티</a>
							<ul class="nav_2depth">
								...
								<%
									String commonSessionLevel= (String)session.getAttribute("sessionLevel");
									if(commonSessionLevel == null) commonSessionLevel="";
									if(commonSessionLevel.equals("top")){
								%>
								<li><a href="/web_homepage_jsl/adm/adm_list.jsp">관리자</a></li>
								<%
									}
								%>
							</ul>
