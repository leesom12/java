...
public class AdminList implements CommonExecute {
	...
	public void execute(HttpServletRequest request) {
		...
		String list_count1 = request.getParameter("t_pageNum");
		if(list_count1 == null) list_count1="5";
		int list_count = Integer.parseInt(list_count1);
		
		/* paging 설정 start*/
		int totalCount = dao.getTotalCount(select,search);
		int list_setup_count = list_count;  //한페이지당 출력 행수 
		...
		request.setAttribute("t_list_count", list_count);
