...
public class EtcRecomment implements CommonExecute {
	...
	public void execute(HttpServletRequest request) {
		...
		String group_no = request.getParameter("t_no2");
		String title = request.getParameter("t_recomment");
		String content= "";
		HttpSession session = request.getSession();
		String reg_id = (String)session.getAttribute("sessionId");
		String reg_date = CommonUtil.getTodayTime();
		String depth_s = request.getParameter("t_depth2");
