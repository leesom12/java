	...
	function updateReply(no){
		...
		<div id="b_right">
			...
			<form name="qna">
				...
				<table class="boardForm">
					...
					<tbody>	
						<tr>
							<th>Reply</th>
							<td colspan="3"><textarea name="t_reply" class="textArea_H250">${t_dto.getReply()}</textarea></td>
						</tr>	
						<tr>
							<th rowspan="2">Writer</th>
			...
			<div class="buttonGroup">
				...
				<a href="javascript:updateReply('${t_dto.getNo()}')" class="butt">Update</a>
